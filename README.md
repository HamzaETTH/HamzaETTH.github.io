...
- **Controls → Wells → Browse Presets**: Search 60 well arrangements, including wide scattered fields and distributed traps; apply with Undo, then adjust spacing, rotation, and strength. See the [preset library guide](docs/gravity-well-presets.md).
